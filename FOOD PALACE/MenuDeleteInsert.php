...
$resultSet = mysql_query("SELECT * FROM itemtable");
	...
	?>
<form id="EditRes" action="MenuDeleteDB.php" method="post" > <?php
	echo"<p>Name: $name<br />Price: $price<br />Item Type: $type<br />Item ID: $id<br />"; ?><?php
	echo "<input type=hidden name=IID value=".$rows['ItemID']." >" ?><?php
	echo "<p>" . "<input  type=submit name=Rid value=DELETE id=DeleteButton  ". " </p>"; ?>
